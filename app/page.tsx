    ...
    ✓ {item}
      ...
      <section className="bg-white px-6 py-16 text-center md:py-20">
        <div className="mx-auto max-w-3xl">
          <div className="mb-5 text-[46px] font-light leading-none text-[#E89A3D]" aria-hidden="true">
            ↓
          </div>

          <h2 className="text-[28px] font-bold leading-tight text-[#545454] md:text-4xl">
            スタジオONCEなら
            <br />
            そのお悩み、
            <br />
            <span className="text-[#E89A3D]">解決できます！</span>
          </h2>
        </div>
      </section>
