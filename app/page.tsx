      ...
      <section id="services" className="scroll-mt-24 bg-[#FFFDF8] px-6 py-20">
        ...
        <div className="mx-auto grid max-w-5xl gap-4 sm:grid-cols-2 md:grid-cols-3 md:gap-5">
          {(services.length > 0
            ...
            <div
              key={item}
              className="group relative overflow-hidden rounded-[28px] border border-[#D8EAC7]/80 bg-white p-5 shadow-[0_18px_45px_rgba(108,143,93,0.12)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_55px_rgba(108,143,93,0.18)] md:p-6"
            >
